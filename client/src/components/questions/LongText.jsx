  ...
  return (
    <div className="w-full">
      <textarea
        ...
        maxLength={maxLength}
        rows={6}
        className="bg-white text-textPrimary w-full px-4 py-3 text-lg border border-border rounded-lg focus:border-primary focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 transition-default resize-y"
      />
